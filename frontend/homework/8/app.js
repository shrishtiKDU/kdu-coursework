    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    data = _a.sent();
                    recipes = data.recipes.map(function (recipe) { return ({
                        image: recipe.image,
                        name: recipe.name,
...
function searchRecipie(searchQuery) {
    return __awaiter(this, void 0, void 0, function () {
        var url, response, data, recipes, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    url = "https://dummyjson.com/recipes/search?q=".concat(encodeURIComponent(searchQuery));
