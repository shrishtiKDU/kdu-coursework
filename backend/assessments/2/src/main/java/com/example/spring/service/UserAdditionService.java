...
public class UserAdditionService implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception{
        personDAO.save(new Person("Shrishti", "shrishti", passwordEncoder.encode("Secure@123"), "ROLE_ADMIN"));
        personDAO.save(new Person("Thanika", "thanika", passwordEncoder.encode("Password@123"), "ROLE_BASIC"));
    }
